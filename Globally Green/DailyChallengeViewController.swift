...
class DailyChallengeViewController: UIViewController {
    ...
    let hard = ["Use safe and environmentally-friendly cleaning products (ex. baking soda, soap flakes, lemon, cornstarch and vinegar)", "Make your own hand sanitizer using rubbing alcohol, aloe vera gel, essential oil drops, and a reusable bottle", "Buy furniture made from reclaimed wood or recycled materials", "Buying loose tea and using a tea strainer requires zero-waste and are generally of higher quality because they are made of whole, unbroken leaves compared to individual tea bags", "Purchase a carbon offset to balance the carbon emissions produced from a recent flight"]
